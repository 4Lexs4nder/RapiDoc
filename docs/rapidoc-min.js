...
`:""}function DR(){const e=new Ue.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function FR(){var e,t,r,n;return F`
  ...
  <section id = 'servers' part="section-servers" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class='regular-font observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap"}'>
    ...
    ${qR.call(this)}
  </section>`}function UR(e,t="toggle"){const r=null==e?void 0:e.closest(".nav-bar-tag-and-paths");if(r){const e=r.classList.contains("expanded");!e||"toggle"!==t&&"collapse"!==t?e||"toggle"!==t&&"expand"!==t||r.classList.replace("collapsed","expanded"):r.classList.replace("expanded","collapsed")}}function MR(e){UR(e.target,"toggle")}function HR(e,t="expand-all"){!function(e,t="expand-all"){const r=[...e.querySelectorAll(".nav-bar-tag-and-paths")];"expand-all"===t?r.map((e=>{e.classList.replace("collapsed","expanded")})):r.map((e=>{e.classList.replace("expanded","collapsed")}))}(e.target.closest(".nav-scroll"),t)}function WR(){var e,t,r,n;if(!this.resolvedSpec||this.resolvedSpec.specLoadError)return F`
      <nav class='nav-bar' part="section-navbar">
        <slot name="nav-logo" class="logo"></slot>
      </nav>
    `;const a=this.resolvedSpec.tags.filter((e=>e.paths.filter((e=>ot(this.matchPaths,e,this.matchType))).length)),o=Object.values(a.reduce(((e,t)=>{const[r,...n]=t.name.split(" - ");return e[r]?e[r].tags.push({...t,name:n.join(" - ")}):e[r]={name:r,tags:[{...t,name:n.join(" - ")}]},e}),{}));return F`
  <nav class='nav-bar ${this.renderStyle}' part="section-navbar">
    <slot name="nav-logo" class="logo"></slot>
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":F`
        <div style="display:flex; flex-direction:row; justify-content:center; align-items:stretch; padding:8px 12px 12px 12px; ${"false"===this.allowAdvancedSearch?"border-bottom: 1px solid var(--nav-hover-bg-color)":""}">
    ...
    ${F`<nav class='nav-scroll' part="section-navbar-scroll">
      ...
      <!-- TAGS AND PATHS-->
      ${o.map((e=>F`<div>
          <div style="${1===e.tags.length?"display:none":""}" class="${e.tags.length>1?"nav-bar-tag":""} ">${e.name}</div>
          <div style="${e.tags.length>1?"margin-left:1em":""}">
            ${e.tags.filter((e=>e.paths.filter((e=>ot(this.matchPaths,e,this.matchType))).length)).map((e=>F`
                <div class='nav-bar-tag-and-paths ${e.expanded?"expanded":"collapsed"}'>
                  ${"General ⦂"===e.name?F`<hr style="border:none; border-top: 1px dotted var(--nav-text-color); opacity:0.3; margin:-1px 0 0 0;"/>`:F`
                      <div 
                        ...
                        @click='${e=>{this.renderStyle,"expand-collapse"===this.onNavTagClick?MR.call(this,e):this.scrollToEventTarget(e,!1)}}'
                      >
                        <div>${e.name}</div>
                        <div class="nav-bar-tag-icon" @click="${e=>{this.renderStyle,"show-description"===this.onNavTagClick&&MR.call(this,e)}}">
                        </div>
                      </div>
                    `}
                  ${"true"===this.infoDescriptionHeadingsInNavBar?F`
                      ${this.renderStyle,"expand-collapse"===this.onNavTagClick?"":F`
      ...
      <!-- COMPONENTS -->
      ${this.resolvedSpec.components&&"true"===this.showComponents&&(this.renderStyle,1)?F`
